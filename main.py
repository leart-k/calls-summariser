...
def audio_to_summary(output_text):
    ...
    total_token_cost = cost_calculations(response_body)
    return results, total_token_cost

def cost_calculations(response_body): 
...
if __name__ ==  "__main__":
    output_text = audio_to_transcript()
    result, total_token_cost = audio_to_summary(output_text)
